      ...
      <Section className="bg-white py-12">
        <Container>
          ...
          >
            ...
            <p>
              This Privacy Policy explains how <strong>The Coral Reef Cabana Co., Ltd.</strong> 
              (operating as "Banana Beach") and <strong>Chamnanthang Co., Ltd.</strong> 
            ...
            <ul>
              <li>
                <strong>The Coral Reef Cabana Co., Ltd.</strong> is the data controller for 
            ...
            <p>
              ...
              please see our <a href="/cookies" className="text-accent hover:underline">Cookie Policy</a>.
            </p>
            ...
            <h3>For General Inquiries (The Coral Reef Cabana Co., Ltd.)</h3>
            <ul>
