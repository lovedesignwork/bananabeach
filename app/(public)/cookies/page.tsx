        ...
        <Container>
          ...
          >
            ...
            <div className="prose prose-slate max-w-none">
              ...
              <p>
                This Cookie Policy explains how <strong>The Coral Reef Cabana Co., Ltd.</strong> 
                (operating as "Banana Beach") uses cookies and similar technologies on our website.
              </p>
              ...
              <ul>
                ...
                <li><a href="https://www.facebook.com/privacy/policy/" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">Meta Privacy Policy</a></li>
                <li><a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">Stripe Privacy Policy</a></li>
              </ul>
