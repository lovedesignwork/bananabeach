      ...
      <Section className="bg-white py-12">
        <Container>
          ...
          >
            ...
            <p>
              Welcome to Banana Beach, operated by <strong>The Coral Reef Cabana Co., Ltd.</strong> 
              These Terms and Conditions govern your use of our website, services, and beach 
              and water activities. By making a booking or participating in our activities, you agree to 
            ...
            <h3>3.7 Cancellation by Banana Beach</h3>
            <p>
            ...
            <ul>
              <li>Weight: Minimum 15kg, Maximum <strong>120kg for water activities</strong></li>
            ...
            <ul>
              ...
              <li>Non-swimmers (for water-based activities)</li>
            ...
            <ul>
              ...
              <li><strong>Swimwear or comfortable beach attire</strong> (water shoes or sandals recommended)</li>
              <li>Long hair should be tied back for water activities</li>
              <li>Remove loose jewelry and accessories before water activities</li>
            </ul>

            <h2>6. Safety and Liability</h2>
            <h3>6.1 Assumption of Risk</h3>
            <p>
              Beach and water activities involve inherent risks including but not 
              limited to drowning, currents, marine life, and physical exertion. By 
            ...
            <ul>
              ...
              <li>Dispose of waste properly and respect the beach and marine ecosystem</li>
            </ul>
            <p>
            ...
            <p>
              Banana Beach may photograph or film activities for promotional, marketing, 
            ...
            <p>
              ...
              the property of The Coral Reef Cabana Co., Ltd. and is protected by copyright 
              and trademark laws. Unauthorized use is prohibited.
            </p>

            <h2>11. Limitation of Liability</h2>
            <p>
              To the maximum extent permitted by law, The Coral Reef Cabana Co., Ltd. and 
            ...
            <h3>The Coral Reef Cabana Co., Ltd. (Banana Beach)</h3>
            <ul>
              <li>Email: relax@bananabeachkohhey.com</li>
              <li>Phone: 081 416 7555</li>
              <li>Address: 44/1 Moo 5, Viset Road, Rawai, Muang, Phuket 83130, Thailand</li>
            </ul>
