  ...
  const parseMarkdown = (text: string) => {
    ...
    for (let i = 0; i < lines.length; i++) {
      ...
      if (line === '') {
        ...
        elements.push(
          <h2 key={i} className="text-lg font-bold text-primary mt-6 mb-3 flex items-center gap-2">
        ...
        elements.push(
          <li key={i} className="ml-4 text-slate-600 mb-1.5 list-disc marker:text-accent">
