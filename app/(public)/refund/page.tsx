          ...
          >
            ...
            <div className="prose prose-slate max-w-none">
              ...
              <ul>
                ...
                <li><strong>How to Cancel:</strong> Email relax@bananabeachkohhey.com with your booking reference</li>
              </ul>
              ...
              <ul>
                ...
                <li>Submit the certificate to relax@bananabeachkohhey.com within 7 days</li>
                <li>Refund will be processed minus the 5% processing fee</li>
              </ul>

              <h2>4. Cancellation by Banana Beach</h2>
              <p>
              ...
              <ol>
                <li>Email <strong>relax@bananabeachkohhey.com</strong> with:
                  <ul>
              ...
              <ol>
                <li>Contact us at relax@bananabeachkohhey.com with your booking reference</li>
              ...
              <div className="not-prose grid md:grid-cols-2 gap-4 mt-6">
                <div className="bg-slate-50 rounded-xl p-4">
                  ...
                  <p className="text-sm text-slate-600">relax@bananabeachkohhey.com</p>
                ...
                <div className="bg-slate-50 rounded-xl p-4">
                  ...
                  <p className="text-sm text-slate-600">081 416 7555</p>
