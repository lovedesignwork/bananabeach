    ...
    <div ref={containerRef} className="relative">
      <div className="relative">
        ...
        <button
          ...
          className="w-full h-11 pl-10 pr-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 text-sm focus:outline-none focus:border-primary text-left"
        >
      ...
      {isOpen && (
        <div 
          className="absolute z-50 mt-2 bg-white rounded-xl p-6 shadow-xl border-2 border-primary min-w-[340px]"
        >
          {/* Header */}
