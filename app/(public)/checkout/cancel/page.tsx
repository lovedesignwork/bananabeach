...
function CancelContent() {
  ...
  return (
    <main className="min-h-screen pt-20 bg-gradient-to-b from-primary to-primary-dark">
          ...
          <div className="p-6 md:p-8">
            ...
            <div className="space-y-3 mb-8">
              ...
              <Link href="/booking" className="block">
                <div className="flex items-center gap-4 p-4 bg-accent/10 hover:bg-accent/20 rounded-xl transition-colors cursor-pointer">
...
export default function CancelPage() {
  return (
    <Suspense fallback={
      <main className="min-h-screen pt-20 bg-gradient-to-b from-primary to-primary-dark flex items-center justify-center">
